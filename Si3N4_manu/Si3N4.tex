...
Among the four terms in Eq.~(\ref{eq:cum-kappa}), we qualitatively investigate the
contributions of $v_\lambda$ and DOS to LTC. The entire band
diagrams and DOSs are almost identical to those reported earlier~\cite{kuwabara,xu}. However, 
...
\begin{figure}[ht]
 \begin{center}
  \includegraphics[width=0.70\linewidth]{Fig5_338_rev.eps}
