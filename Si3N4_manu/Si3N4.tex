...
The band index $p$ is set as 1, 2,... simply in ascending order of the harmonic phonon
frequency at a $\mathbf{q}$.  The relaxation time due to phonon-phonon scattering was obtained as,
...
$\boldsymbol{\kappa}$.
The paths in the band diagram correspond to the left and bottom edges of the
cross-section.
In the band diagrams, the dispersion curves denoted by a thick gray line
correspond to the profiles of the edge part of the cross-section for $p$=4; they
are denoted so in order to show more clearly the relationship between the band
diagram and cross-section. 
...
The contour maps including the most of the acoustic phonon modes are $p$=1, 2, and
...
much higher $\omega_\lambda$ than at the K point.
...
Comparing the contour maps for $p$=4 of $\alpha$ and $\beta$ phases, there is a
...
tendency is seen for the most branches of the optical phonon modes $\lesssim$ 12
THz, where the phonon modes of the $\beta$ phase largely contribute to $\boldsymbol{\kappa}$.
...
\begin{figure*}[h]
% \begin{center}
	 \includegraphics[width=0.9\linewidth]{figure_dos_jdos_dkc_m1010_dos_wo_arrows_bw_nolog.eps}
...
not considered in this section. For the investigation, the derivative of
...
\begin{figure}[ht]
 \centering
  \includegraphics[width=0.9\linewidth]{figure_wjdoss_gray.eps} \caption{
...
The brighter (darker) color indicates more (less) longitudinal character
of the phonon mode.  In Fig.~\ref{fig:Fig7_338}(b), the color contrast
is set according to $\sum_{i}[e_x(i,\lambda)^2+e_y(i,\lambda)^2]$, the fraction
of the eigenvector component on the $ab$ plane. 

Fig.~\ref{fig:Fig7_338}(b) show much clearer contrast between the two branches
in the $\beta$ phase than Fig.~\ref{fig:Fig7_338}(a).  Therefore, in the $\beta$
phase,  the vibration within the $ab$ plane is more easily scattered than that
perpendicular to the plane: This tendency is independent on how much
longitudinal character the corresponding phonon mode has.
