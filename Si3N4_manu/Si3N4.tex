...
information of $\mathbf{v}_\lambda$ and number of heat carriers.  Phonon linewidths
are shown as scatter plots of
$(\Gamma_\lambda, \omega_\lambda)$ in Fig.~\ref{fig:Fig5_338_rev}-d. 
The remaining term in Eq.~(\ref{eq:kappa}), $c_\lambda$ is nearly constant
($k_B$) at 300 K and disregarded in our discussion. 
...
low frequency region with the phonon modes contributing to the
