...
The behavior of the linewidth in $\gamma$-Si$_3$N$_4$ is much different from
...
$\gamma$-Si$_3$N$_4$.
We can qualitatively conclude that the larger linewidths and group velocities in
$\gamma$-Si$_3$N$_4$ neutralize $\kappa^\text{c}$ to the value as small as
$\kappa^\text{c}_{xx}$ of $\beta$-Si$_3$N$_4$.


The overall shape of the linewidths is consistent with the weighted JDOS in
Fig.~\ref{fig:Fig5_338_rev}-e. Especially, Similar plateaus to those in the
linewidths are seen in the weighted JDOS. 
The vertical fluctuations in Figs.~\ref{fig:Fig5_338_rev}-d become larger in the
order of $\alpha$-, $\beta$-, and $\gamma$-Si$_3$N$_4$. A similar trend is seen in 
the behaviors of the average phonon-phonon interaction strengths in
Fig.~\ref{fig:Fig5_338_rev}-f. 
The approximated linewidth $\tilde{\Gamma}_\lambda$ in Fig.~\ref{fig:Fig5_338_rev}-g 
is thus safely consistent with the linewidths. 
For quantitative comparison, the correlation coefficients between
\Gamma$_\lambda$ and $N_\lambda$ are 0.97, 0.92, and 0.54 for $\alpha$-, $\beta$-,
and $\gamma$-Si$_3$N$_4$. 
Those between \Gamma$_\lambda$ and $P_\lambda$ are 0.94, 0.84, and 0.73.
Those between \Gamma$_\lambda$ and $\tilde{\Gamma}_\lambda$ are 0.96, 0.92, and
0.71. 
