...
\begin{figure}[H]
	 \begin{center}
		   \includegraphics[width=0.90\linewidth]{Figure_kaccum_for_alpha_beta_gamma_phases.eps}
...
conductivity, $\boldsymbol{k}^c(\omega)$. 
...
phonon frequency  
distribution on the $b^*c^*$ plane is shown in Fig.\ref{fig:Fig4_ver5_338}-c. Since the
cross-section on the other planes 
containing the $c^*$ axis did not differ much from that shown in 
Fig.\ref{fig:Fig4_ver5_338}-c, we focus on the $b^*c^*$
plane as a representative of all such planes. We show only the frequencies of the 
four modes from the lowest frequency, \#1, 2, 3, and 4,  because they contribute significantly to
$\boldsymbol{\kappa}$.
The paths of the band diagrams correspond to the edges in the bottom and left
sides of the cross-sections. The dispersion curves on these edges for the
cross-section of \#4 are denoted by a thick gray line in
Fig.\ref{fig:Fig4_ver5_338}-b, so as to connect the dispersion curves with the
cross-sections. 

In the band diagram of the $\alpha$ phase, the dispersion curves of the acoustic
phonon modes are not much different between the cases for the $\Gamma$-A and $\Gamma$-K
paths, indicating the isotropic group velocities of the acoustic phonons.
The contour maps including the most of the acoustic phonon modes are \#1, 2, and
3 in Fig.\ref{fig:Fig4_ver5_338}-c. For the $\alpha$ phase, these maps clearly show the
...
the band diagram of the $\beta$ phase, the acoustic phonon modes show 
much higher $\omega_\lambda$ at the A point than at the K point.
In the contour maps of \#1, 2, and 3 for the $\beta$ phase, the gradients of
$\omega_\lambda$ are, in the most part, parallel to the $\Gamma$-A path; the
...
Comparing the contour maps of \#4 for $\alpha$ and $\beta$ phases, there is a
tendency that $\beta$ phase has larger group velocities than $\alpha$ phase.
Comparing the band diagrams of the $\alpha$ and $\beta$ phases, the same
tendency is seen for the most branches of the optical phonon modes $\lesssim$ 10
THz, where the phonon modes largely contribute to $\boldsymbol{\kappa}$.
...
$\alpha$ and $\beta$ phases.  The gradients of the dispersion curve  are
largest among the three phases, as expected by the largest $B$.
