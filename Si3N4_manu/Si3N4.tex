...
relatively large.  \textcolor {blue}{Several technieques on fabrication processes have been reported to align $c$-axis
directions of $\beta$-Si$_3$N$_4$ grains in ceramics.~\cite{takahashi,hirao,zhu,akimine} The thermal conductivity of
the textured ceramics would match or exceed that of w-AlN.} 

Although the fabrication of millimeter-sized single
crystals has been reported for the $\beta$ phase,~\cite{yamamoto} the thermal conductivity of a
...
The ratio $\kappa_{zz}/\kappa_{xx}$ agreed well with the experimental results 
obtained by Li {\it et al.}~\cite{li} 

The MD results presented that the different stacking orders beween $\alpha$-
and $\beta$-Si$_3$N$_4$ altered their LTC largely, \textcolor{blue}{whose
mechanism was not investigated.} On the other hand, the recent LTC calculation
based on first principles calculation and Boltzman transport theory showed that
in many polymorphs of the wurtzite and zincblende structures, which have
different stacking orders of the densest atom planes as ABAB.. and ABCABC..,
these orders merely altered the LTCs.~\cite{phono3py} \textcolor{blue}{ The
same behavior was also observed for the phonon linewidth distribution and
phonon density of states.~\cite{phono3py} In Si$_3$N$_4$, correlation
between the LTCs and phonon properties is not clarified.  It is interesting
...
\textcolor{blue}{We apply the same first principles approach to the $\gamma$
phase as well, for systematic understanding of the LTC in the Si$_3$N$_4$
...
data and other calculation results.  Then we investigate the
