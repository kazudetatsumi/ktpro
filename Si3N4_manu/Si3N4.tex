...
distributions on the $b^*$-$c^*$ plane.  The distributions for four modes from
the lowest frequency are shown, because these modes contribute significantly to
the $\boldsymbol{\kappa}$.  We did not find any significant differences in the
distributions of these $\omega_{\lambda}$ when we investigated them on the
other planes containing the $c^*$ axis.  Thus we select the $b^*$-$c^*$ plane
as a representative plane.  In the $\alpha$ phase, the distributions are nearly
isotropic.  Their gradients, the group velocities projected onto the
