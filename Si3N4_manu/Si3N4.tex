...
\begin{figure}[ht]
 \centering
  ...
  The first and fourth rows for the $\alpha$ and $\beta$ phases are WJDOS at the same $\Gamma$-point but calculated
...
$\gamma$ phase has slightly small intensities of the total WJDOS below $\sim$ 10 THz.
