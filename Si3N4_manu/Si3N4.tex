...
the phase space by the weighted joint density of states, 

eq.wjdos.

, where similar plateaus at 6--8 THz for $\alpha$- and $\beta$-Si$_3$N$_4$ and above
$\sim$ 7 THz for $\gamma$-Si$_3$N$_4$ are found. 
Moreover, the calculated linewidths vary more widely in the order of $\alpha$-, $\beta$-, and
$\gamma$-Si$_3$N$_4$. $P_\lambda$, the average phonon-phonon interaction
strengths in Fig.~\ref{fig:Fig5_338_rev}-f vary more largely in the same order.
The approximated linewidths, $\tilde{\Gamma}_\lambda$ in
Fig.~\ref{fig:Fig5_338_rev}-g, composed of the products of $N_\lambda$ and
$P_\lambda$, show similar frequency-dependences to the linewidths as well. 
For quantitative comparison, the correlation coefficients between the vertical
axes of Figs.~\ref{fig:Fig5_338_rev}-(d,e), (d,f) and (d,g) are (0.94, 0.84,
and 0.73 for $\alpha$-, $\beta$-, and 
$\gamma$-Si$_3$N$_4$), (0.97, 0.92 and 0.54) and (0.96, 0.92 and 0.71)
respectively. 
