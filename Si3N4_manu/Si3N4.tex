...
$\alpha$ phase, owing to the different stacking manners of the basal layer structures.
The anisotropic increments of $\omega_\lambda$
indicate the anisotropic $\mathbf{v}_\lambda$.  This will be investigated
further in the following sections.  Normally, dispersion curves of optical
phonon branches are flat; however, the 
\begin{figure}[H]
	 \begin{center}
		   \includegraphics[width=0.90\linewidth]{Fig4_ver5_338_resize2_woDOS_color_simplified_no_symm.eps}
		   \caption{(color online) (a) Brillouin-zones, (b)  dispersion curves for the three phases and (c) contour maps 
			   of phonon frequencies for the $\alpha$ and $\beta$ phases, on the  $b^*c^*$  planes of Brillouin-zones. 
			   The maps for the four lowest-frequency
			   phonon modes are shown. 
		   \label{fig:Fig4_ver5_338} }
    \end{center}
\end{figure}
\noindent
$\beta$ phase shows significantly large
gradients for the low frequency optical phonon branches. This indicates that
the \rm{v}$_{\lambda}$ of these phonon modes are large.
