...
conductivity, $\boldsymbol{k}^c(\omega)$ and its
derivative $d\boldsymbol{\kappa}^c/d\omega$. 
...
The Brillouin zones and phonon band diagrams of the three
phases are shown in Figs.\ref{fig:Fig4_ver5_338}-a and b. In
Fig.\ref{fig:Fig4_ver5_338}-b, we investigate the frequency gradients, the
group velocities projected on the paths along the nonequivalent reciprocal
axes, with particular focus on their anisotropy in the $\alpha$ and $\beta$
phases. This was not investigated in the previous works. The band diagrams on
the other high-symmetry paths are almost identical to those
reported\cite{kuwabara,xu} and thus are not shown.  
For the $\alpha$ and $\beta$ phases, in order to investigate the anisotropy in
the group velocities within the whole of the Brillouin zone,
Fig.\ref{fig:Fig4_ver5_338}-c shows  the cross sections of the phonon
frequencies distributions on the
\begin{figure}[H]
	 \begin{center}
		   \includegraphics[width=0.90\linewidth]{Fig4_ver5_338_resize2_woDOS_color_simplified_no_symm.eps}
		   \caption{(color online) (a,b) Brillouin-zones and  band diagrams of the three phases. (c) Contour maps 
			   of phonon frequencies for the $\alpha$ and $\beta$ phases, on the  $b^*c^*$  planes of Brillouin-zones. 
			   The maps for the four lowest-frequency phonon modes (\#1, 2, 3, and 4) are shown. In the band diagrams, the dispersion 
			   curve of \#4 is denoted by a thick gray line.
		   \label{fig:Fig4_ver5_338} }
    \end{center}
\end{figure}
\noindent
$b^*c^*$ plane in the Brillouin zone: The cross-sections of other planes
containing the $c^*$ axis did not differ much from
Fig.\ref{fig:Fig4_ver5_338}-c; thus, we focus on the results for the $b^*c^*$
plane as representative of all such planes. We show only the frequencies of
four modes from the lowest frequency because they contribute significantly to
$\boldsymbol{\kappa}$. To more clearly relate the band diagrams and the contour
maps, in the band diagrams of the $\alpha$ and $\beta$ phases in
Fig\ref{fig:Fig4_ver5_338}-b, the dispersion curve of the phonon modes
corresponding to the contour map \#4 in Fig\ref{fig:Fig4_ver5_338}-c is denoted
by a thick gray line.

In the band diagram of the $\alpha$ phase, the acoustic phonon branches
increase their $\omega_\lambda$ from the zone center similarly along the two
paths, indicating the isotropic group velocities of the acoustic phonons. This
is more clarified by the contour maps of \#1, 2 and 3: The most of the
iso-frequency lines are parallel to the circular dash lines.  On the other
hand, in the band diagram of the $\beta$ phase, the phonon frequencies of the
acoustic phonon branches increase from the zone center much more on the
$\Gamma$A path than the $\Gamma$K path. The corresponding contour maps of \#1,
2, and 3 for the $\beta$ phase in Fig.\ref{fig:Fig4_ver5_338}-c show that the
gradients of $\omega_\lambda$ are, in the most part of the reciprocal plane,
parallel to the $\Gamma$A path, i.e., the $c^*$ axis direction.  This
difference is due to the $\Gamma$-A path lengths.  The $\beta$ phase has an
approximately twice longer path than the $\alpha$ phase; the lattice constant
$c$ of the $\beta$ phase is nearly half that of the $\alpha$ phase, owing to
the different stacking manners of the basal layer structures.

Normally, dispersion curves of optical phonon branches are flat; however, the
$\beta$ phase shows significantly large gradients for the low frequency optical
phonon branches. For example, the dispersion curve denoted by \#4 of the
$\beta$ phase shows larger gradients than that of the $\alpha$ phase: The
corresponding contour map of the $\beta$ phase show a larger number of
iso-frequency lines than that of the $\alpha$ phase, being rather parallel to
the $\Gamma$K path.  The group velocity of these phonon modes is large and
orients to the $c^*$ axis direction.
...
\begin{figure*}[ht]
 \begin{center}
	 \includegraphics[width=0.9\linewidth]{figure_dos_jdos_kc_m1010_dos_wo_arrows_bw_nolog.eps}
...
the other phases. 
%The weighting factors of $(n_{\lambda'}-n_{\lambda''})$ reduce
%$N_2^{(1)}$ near 0 THz and those of $(n_{\lambda'}+n_{\lambda''}+1)$ enhance
%$N_2^{(2)}$ in the high frequency range. The latter reduces
%$d\boldsymbol{\kappa}^c/d\omega$ in the high frequency range for all the
%phases.  
