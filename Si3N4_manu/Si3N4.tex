...
\nabla_{\mathbf{q}}\omega_\lambda$ parameter regarding to the boundary mean
free path. We consider $\tau_{\lambda,\text{bs}}$ as a
variable parameter and included it to LTCs according to Matthiessen's rule.
