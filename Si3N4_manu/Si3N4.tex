...
integrated there. In order to visually show the similarity or differences in
these properties among the phases, we plot in Fig.~\ref{fig:Fig5_338_rev} the
frequency distribution of the properties: The phonon density of states (DOS)
...
phonons largely contribute to the $\boldsymbol{\kappa}$. Their 1st derivatives
are also shown to clearly identify the frequencies. By weighting the DOS with
...
Fig.~\ref{fig:Fig5_338_rev}-a. They are crudely  related to the flattening of
...
frequency range beyond the peak. This is due to the anisotropic dispersions of
