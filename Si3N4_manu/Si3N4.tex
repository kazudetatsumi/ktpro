...
systematic understanding. After the methodology \textcolor{blue}{is described}, we
examine the validity of the present results, \textcolor{blue}{through comparison
of} the calculated thermal properties with the available experimental and
theoretical references.  The characteristic behaviors of  $\boldsymbol{\kappa}$
...
\textcolor{blue}{difference \bf{(or plural form of differences?)}} between
...
limited to use the single-mode RTA to take advantage of its closed form of
$\boldsymbol{\kappa}$\textcolor{blue}{, which can be intuitively understood in
...
thermal expansion. \textcolor{blue}{The differences in $\boldsymbol{\kappa}$ for $T$=300, 600,
...
\textcolor{blue}{Comparison with the experimental coefficient is useful to validate the present
...
\textcolor{blue}{along the inequivalent reciprocal axes}, with particular focus
on their anisotropy in the $\alpha$ and $\beta$ phases. This was not
investigated in the previous works. \textcolor{blue}{The band diagrams on the
...
as large as those of the other phases. We will examine this in detail later. As
a result, $d\kappa_{xx}^c/d\omega$ has relatively low intensities. The
