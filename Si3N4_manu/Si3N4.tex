...
LTC values calculated within the quasi-harmonic approximation (QHA)~\cite{dove-p76}.
The crystal structure of $\beta$-Si$_3$N$_4$ at the minimum Helmholtz free energy was calculated for
a finite temperature and 0 GPa.
Then LTC for the temperature was calculated using this crystal structure.
This LTC was compared with the LTC for the same temperature but calculated with the crystal structure optimized for  0 K and 0 GPa.
As the finite temperature set as 300, 600, 900, 1200, and 1500 K, the relative differences between the LTCs with the two structures were found less than 1 \%, similar to the case of Si and Ge~\cite{ward-ltc}. For the present study,
these differences are negligible and the LTCs calculated with the latter structure are adopted.}
