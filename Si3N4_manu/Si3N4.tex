...
\subsection{Dispersion curves \textcolor{red}{[pending!!]}}
...
\subsection{$\omega_\lambda$ contour map on the reciprocal plane
	\textcolor{red}{[add more, for example, isotropic distribution at low
frequency i.e., $\lesssim$ 2 THz in $\beta$ phase.]}}
...
In both of the phases, the countours  $leq$ 2 THz ar
In the $\alpha$ phase, the
$\omega_{\lambda}$ distributions and thus $\mathbf{v}_{\lambda}$ are almost
isotropic. In the $\beta$ phase, the contours are rather parallel to the $b^*$
axis, and thus the $\mathbf{v}_{\lambda}$ tends to orient toward the $c^*$ axis
direction. This confirms the large anisotropy of $\mathbf{v}_{\lambda}$ of the
acoustic and low-frequency optical phonon branches for the $\beta$ phase.
