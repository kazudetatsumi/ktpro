...
the interatomic potentials proposed by Vashishta {\it et al.} Although the
...
results obtained by Li {\it et al.} Moreover, the MD results suggest that the
different stacking orders in $\alpha$- and $\beta$-Si$_3$N$_4$ alter much their
LTC. On the other hand, the recent LTC calculation using first principles
...
LTCs.~\cite{phono3py} \textcolor{blue}{The dependences of the LTC on the
stacking manners in $\alpha$- and $\beta$-Si$_3$N$_4$ should be examined by
the same method.} For $\gamma$-Si$_3$N$_4$, its thermal conductivity has not
been experimentally reported; it has been estimated only by the Slack
