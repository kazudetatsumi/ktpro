...
% \right]\right\},
\end{align}
Nevertheless the frequency dependences of the linewidths for all the Si$_3$N$_4$
phases can be explained in terms of the phase space. Similar plateaus as in the
linewidths are found  at 6--8 THz for $\alpha$- and $\beta$-Si$_3$N$_4$
and above $\sim$ 7 THz for $\gamma$-Si$_3$N$_4$. 
