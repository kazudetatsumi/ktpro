...
class CROSS:
    ...
    def plot_crosssection(self, cnum, xyyx=False):
        ...
        self.plotter(lims_int[0, :], lims_int[1, :],
                     ...
                     4, 1, cnum, self.devs[0], self.wholeranges[0, :],
        ...
        self.plotter(lims_int[1, :], lims_int[3, :],
                     ...
                     4, 1, cnum+1, self.devs[1], self.wholeranges[1, :],
        ...
        self.plotter(lims_int[0, :], lims_int[3, :],
                     ...
                     4, 1, cnum+2, self.devs[2], self.wholeranges[0, :],
                     self.wholeranges[3, :], cposinfo)
        ...
        self.plotter(lims_int[2, :], lims_int[3, :],
                     ...
                     4, 1, cnum+3, self.devs[2], self.wholeranges[2, :],
                     self.wholeranges[3, :], cposinfo)
...
#
#
#    cross_Ei42 = CROSS(outfile, orthotope_lims, wholeranges, devs,
#                       cpos, hvlofs=False, binwidths=binwidths)
...
run()
plt.savefig("crosssection_demo.png")
plt.show()
