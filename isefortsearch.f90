...
contains
  ...
  subroutine cost4d(maxnw3, maxnw2, maxnw1, maxnw0, datasize3, datasize2, datasize1, datasize0,& 
    ...
    integer hx, hy, hz, hw, px, py, pz, pw, nw0, nw1, nw2, nw3, idx1d
	ise(:,:,:,:) = 0.0
	idx1d = 0 
	do nw0 = 1, maxnw0
	do nw1 = 1, maxnw1
	...
	print *, ise(nw(1), nw(2), nw(3), nw(4)), nw
