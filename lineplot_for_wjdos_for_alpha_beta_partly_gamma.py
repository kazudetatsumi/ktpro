...
plt.plot(cdataA0[:, 0], (cdataA0[:, 1]+cdataA0[:, 2])/cz**2, color="k", label="aSi3N4", linewidth=1.3, linestyle=(0, (1.0, 1.5)))
plt.plot(sdataA0[:, 0], (sdataA0[:, 1]+sdataA0[:, 2])/sz**2, color="k", label="bSi3N4", linewidth=0.8)
#plt.plot(gdataA0[:, 0], (gdataA0[:, 1]+gdataA0[:, 2])/gz**2, color="gray", label="gSi3N4", linewidth=0.1)
yz = 0*gdataA0[:, 0]
plt.fill_between(gdataA0[:, 0], yz, (gdataA0[:, 1]+gdataA0[:, 2])/gz**2, facecolor='lightgray', linewidth=0.1)
...
plt.subplot(6, 1, 2)
plt.plot(cdataA1[:, 0], (cdataA1[:, 1]+cdataA1[:, 2])/cz**2, color="k", label="aSi3N4", linewidth=1.3, linestyle=(0, (1.0, 1.5)))
plt.plot(sdataA1[:, 0], (sdataA1[:, 1]+sdataA1[:, 2])/sz**2, color="k", label="bSi3N4", linewidth=0.8)
...
plt.subplot(6, 1, 3)
plt.plot(cdataA2[:, 0], (cdataA2[:, 1]+cdataA2[:, 2])/cz**2, color="k", label="aSi3N4", linewidth=1.3, linestyle=(0, (1.0, 1.5)))
plt.plot(sdataA2[:, 0], (sdataA2[:, 1]+sdataA2[:, 2])/sz**2, color="k", label="bSi3N4", linewidth=0.8)
...
plt.subplot(6, 1, 4)
plt.plot(cdataK0[:, 0], (cdataK0[:, 1]+cdataK0[:, 2])/cz**2, color="k", label="aSi3N4", linewidth=1.3, linestyle=(0, (1.0, 1.5)))
plt.plot(sdataK0[:, 0], (sdataK0[:, 1]+sdataK0[:, 2])/sz**2, color="k", label="bSi3N4", linewidth=0.8)
plt.text(52, 19, 'q=(0, 0, 0)')
plt.xticks(x, " ")
plt.ylim(0, 28)
plt.yticks([0, 10, 20])
...
plt.subplot(6, 1, 5)
plt.plot(cdataK1[:, 0], (cdataK1[:, 1]+cdataK1[:, 2])/cz**2, color="k", label="aSi3N4", linewidth=1.3, linestyle=(0, (1.0, 1.5)))
plt.plot(sdataK1[:, 0], (sdataK1[:, 1]+sdataK1[:, 2])/sz**2, color="k", label="bSi3N4", linewidth=0.8)
...
plt.subplot(6, 1, 6)
plt.plot(cdataK2[:, 0], (cdataK2[:, 1]+cdataK2[:, 2])/cz**2, color="k", label="aSi3N4", linewidth=1.3, linestyle=(0, (1.0, 1.5)))
plt.plot(sdataK2[:, 0], (sdataK2[:, 1]+sdataK2[:, 2])/sz**2, color="k", label="bSi3N4", linewidth=0.8)
