...
plt.plot(omega1,1/gamma1*0.001,'o',label="beta",markersize=3)
plt.plot(gomega1,1/ggamma1*0.001,'o',label="gamma",markersize=3,c='red')
...
plt.title("tau vs omega")
plt.plot(omega1,1/gamma1*0.001,'o',label="beta",markersize=3)
plt.plot(aomega1,1/agamma1*0.001,'o',label="alpha",markersize=3,c='red')
plt.legend(loc='upper right')
plt.xlim(0,12)
plt.ylim(0,1.5)
plt.yticks([0,0.5,1.0,1.5])
