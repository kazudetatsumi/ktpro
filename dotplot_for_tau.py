...
plt.plot(omega1,1/gamma1*0.001,'.',label="beta",markersize=3,c='blue',fillstyle='full')
#plt.plot(gomega1,1/ggamma1*0.001,'.',label="gamma",markersize=3,c='green',fillstyle='full')
#plt.plot(aomega1,1/agamma1*0.001,'.',label="alpha",markersize=3,c='red',fillstyle='full')
