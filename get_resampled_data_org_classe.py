...
class Sget_qlist(gq):
    ...
    #    #print("!!!!!!TESTING dump self.DAT")
    #    #for ecaidx in range(0, self.DAT.PutSize()):
    #    #    for ecidx in range(0, self.DAT(0).PutSize()):
    #    #        #print(self.DAT(ecaidx, ecidx).PutXList())
    #    #        #print(self.DAT(ecaidx, ecidx).PutYList())
    #    #        #print(self.DAT(ecaidx, ecidx).PutEList())
    #    #        print(np.sum(np.abs(np.array(self.DAT(ecaidx, ecidx).PutEList()
    #    #                                     ) -
    #    #                     np.array(self.DAT(ecaidx, ecidx).PutYList())**0.5
    #    #                            )))
    #    #print("!!!!!!TESTING dump self.DAT")
    #    if frac:
