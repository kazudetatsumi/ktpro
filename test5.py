...
class Structure:
    ...
    def to_polymlp(self) -> Dict[str, Any]:
...
def get_energies(
    ...
    *,
    ...
    if backend == "polymlp-batch":
        return polymlp_eval_batch(polymlp_opts, r_st, irr_pts, center_frac)
...
def main(
    ...
    # (Optional) If you prefer to keep original atom order/type labelling:
    # r_st = reorder_like(org_st, r_st, rep['map_old_to_new'], rep['type_map'])
