...
class qens_model_fit(qbr):
    ...
    def getdata(self, frac):
        ...
        #print(self.outfile)
        self.outfile = self.prefix + "/p6/teste/outhist" + self.runNo + "m.pkl"
        #self.outfile = self.prefix + "/p6/teste/outhist" + self.runNo + "m.pkl"
        print(self.outfile)
        self.loadfile()
        orghout = self.outall
        #self.outfile = self.orgprefix + "outkde" + self.runNo + "m.pkl"
        self.outfile = self.prefix + "/p6/resamples/" + self.nM + "/outkde" + self.runNo +\
            "me.pkl"
        ...
        self.outfile = self.prefix + "/p6/resamples/" + self.nM
