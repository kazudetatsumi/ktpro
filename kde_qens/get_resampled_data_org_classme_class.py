...
from get_resampled_data_org_classme import Sget_qlist as sgq


class SSget_qlist(sgq):
    def __init__(self, runNo, TimeParam, qmin, qmax, binw="0.00025",
                 maskfile="maskTY140218ForAfterRun52.txt"):
        super().__init__(pklfile="run" + str(runNo) + "spectraorge.pkl",
                         maskfile=maskfile)
        self.get_org_data(binw, runNo, TimeParam=TimeParam)
