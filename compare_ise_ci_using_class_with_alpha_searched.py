...
def run():
    ...
    ic.create_fig()
    ic.plot_cis(shift=0.034, alpha=alpha, vlims=vlims)
    ...
    vlims = vlims_expt/alpha*alpha_expt
    ic.get_all_data()
    ic.plot_cis(shift=0.006, ylabel=False, alpha=alpha, vlims=vlims)
    ...
    ic.get_all_data()
    ic.plot_cis(shift=0.01, ylabel=False, vlims=vlims, alpha=alpha)
