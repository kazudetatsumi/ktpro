...
//$adminpass = ''; // PHP md5()  'pass' //$adminpass = '{x-php-md5}1a1dc91c907325c69271ddf0c944bc72'; // PHP md5()  'pass'
$adminpass = ''; // PHP md5()  'pass' //$adminpass = '{x-php-md5}1a1dc91c907325c69271ddf0c944bc72'; // PHP md5()  'pass'
...
//$adminpass = ''; // PHP md5()  'pass'
//$adminpass = 'hogehoge'; // PHP md5()  'pass'

//$adminpass = '{x-php-md5}1a1dc91c907325c69271ddf0c944bc72'; // PHP md5()  'pass'
$adminpass = '{x-php-md5}a8e6eeec12f852de8e6606eac8308b43'; // PHP md5()  'mlfroot'
...
$auth_users = array(
	// Username => password
	'inayoshi'	=> 'inayoshi', // Cleartext
	'taniguchi'	=> 'taniguchi', // Cleartext
	'moriyama'	=> 'moriyama', // Cleartext
	'katsumata'	=> 'katsumata', // Cleartext
	'sono'	=> 'sono', // Cleartext
	'obata'	=> 'obata', // Cleartext	
...
//	'/業務記録/'		=> 'moriyama,inayoshi',
//	'/限定'		=> 'moriyama,inayoshi',
//	'/mori/'		=> 'moriyama',
//	'/RCM/'		=> 'moriyama,inayoshi',
//	'/サーバ管理/'		=> 'moriyama,inayoshi,taniguchi,katsumata',
//	'/カレンダー'		=> 'moriyama,inayoshi,taniguchi,katsumata',
//	'/障害データベース/'		=> 'moriyama,inayoshi,taniguchi,katsumata',
...
$cycle  =   0.5; // Wait N hours between backup (0 = no wait)
$maxage = 720; // Stock latest N backups
...
//$non_list = '^\:';
//$non_list = '^\:|(-01)$|(-02)$|(-03)$|(-04)$|(-05)$|(-06)$|(-07)|$(-08)|$(-09)|(-010)$|(-011)$|(-012)$|(mori)|(限定)';
$non_list = '^\:|(限定)';
...
// profile: A group of browsers
	...
	// Sample: "J-PHONE/2.0/J-T03"	// 2.0は"ブラウザの"バージョ･・	// Sample: "J-PHONE/4.0/J-SH51/SNxxxx SH/0001a Profile/MIDP-1.0 Configuration/CLDC-1.0 Ext-Profile/JSCL-1.1.0"
