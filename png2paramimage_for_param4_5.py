...
def run():
    ...
    modify_params(ptn2, orgvalues, params[5:6], param_values[5:6], 1, 4, 0)
    modify_params(ptn2, orgvalues, params[5:6], param_values[5:6], 2, 0, 1)
    modify_params(ptn2, orgvalues, params[5:6], param_values[5:6], 3, 1, 2)
