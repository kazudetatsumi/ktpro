...
class convNet:
    def __init__(self, input_dim=(1, 1, 2299),
            conv_params={'filter_num':30, 'filter_height':1, 'filter_width':5, 'pad':0, 'stride':1},
        ...
        print("pool_output_size, FN, OH, OW, POH, POW", pool_output_size, FN, OH, OW, POH, POW)

        self.params = {}
        self.params['W1'] = wstd*np.random.randn(FN, C, FH, FW)    # FN, C, FH, FW
        self.params['b1'] = np.zeros(FN)                                                                            # FN
