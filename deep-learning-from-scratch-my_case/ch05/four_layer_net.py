...
class fourLNet:
    def __init__(self, dsize, hsize1, hsize2, hsize3, osize, wstd=0.1):
        ...
        self.params['W3'] = wstd * np.random.randn(hsize2, hsize3)
        self.params['b3'] = np.zeros(hsize3)
        self.params['W4'] = wstd * np.random.randn(hsize3, osize)
        self.params['b4'] = np.zeros(osize)
    ...
    def numerical_grad(self, x, t):
        ...
        grads['W4'] = numerical_gradient(f, self.params['W4'])
        grads['b4'] = numerical_gradient(f, self.params['b4'])
        return grads
