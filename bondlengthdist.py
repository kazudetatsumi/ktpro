...
def run():
    ...
    call, cardfSiSi, cstereoSiSi, crdfSiSi, crdfSiN, crdfNN =\
        caserun(ccar, [2, 2, 3], 2.0, 20)
    sall, sardfSiSi, sstereoSiSi, srdfSiSi, srdfSiN, srdfNN =\
        caserun(scar, [2, 2, 6], 2.0, 20)
