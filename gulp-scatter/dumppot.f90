...
!
  ...
  use four
  use general
  use kim_models,    only : kim_model, nkimmodel, nlibnkimmodel
  use library
  use molecule
  use one
  use plane
          ...
          if (nmptr.gt.0) then
            if (l14scale) then
              ...
              elseif (ncombipower(i).eq.1) then
                write(iout,'(''lenn epsilon zero product '',i2,1x,i2,1x,a5,1x,a4,1x,f6.4,2(1x,a9))') &
                  im,in,mword(nmptr),mmword,scale14(i),(botyword(nbotyptr(j)),j=1,nboty)
              endif
            else
              if (ncombipower(i).eq.6) then
              ...
              elseif (ncombipower(i).eq.2) then
                write(iout,'(''lenn epsilon zero geometric '',i2,1x,i2,1x,a5,1x,a4,2(1x,a9))') &
                  im,in,mword(nmptr),mmword,(botyword(nbotyptr(j)),j=1,nboty)
              elseif (ncombipower(i).eq.1) then
                write(iout,'(''lenn epsilon zero product '',i2,1x,i2,1x,a5,1x,a4,2(1x,a9))') &
                  im,in,mword(nmptr),mmword,(botyword(nbotyptr(j)),j=1,nboty)
              endif
            endif
          else
            if (l14scale) then
              ...
              elseif (ncombipower(i).eq.2) then
                write(iout,'(''lenn epsilon zero geometric '',i2,1x,i2,1x,a4,1x,f6.4,2(1x,a9))') &
                  im,in,mmword,scale14(i),(botyword(nbotyptr(j)),j=1,nboty)
              elseif (ncombipower(i).eq.1) then
                write(iout,'(''lenn epsilon zero product '',i2,1x,i2,1x,a4,1x,f6.4,2(1x,a9))') &
                  im,in,mmword,scale14(i),(botyword(nbotyptr(j)),j=1,nboty)
              endif
            else
              if (ncombipower(i).eq.6) then
              ...
              elseif (ncombipower(i).eq.2) then
                write(iout,'(''lenn epsilon zero geometric '',i2,1x,i2,1x,a4,2(1x,a9))') &
                  im,in,mmword,(botyword(nbotyptr(j)),j=1,nboty)
              elseif (ncombipower(i).eq.1) then
                write(iout,'(''lenn epsilon zero product '',i2,1x,i2,1x,a4,2(1x,a9))') &
                  im,in,mmword,(botyword(nbotyptr(j)),j=1,nboty)
              endif
            endif
          endif
              ...
              if (lnoninteger) then
                ...
                elseif (ncombipower(i).eq.2) then
                  write(iout,'(''lenn epsilon geometric '',f7.4,1x,f7.4,1x,a5,1x,a4,1x,f6.4,2(1x,a9))') &
                    tpot(1,i),tpot(2,i),mword(nmptr),mmword,scale14(i),(botyword(nbotyptr(j)),j=1,nboty)
                elseif (ncombipower(i).eq.1) then
                  write(iout,'(''lenn epsilon product '',f7.4,1x,f7.4,1x,a5,1x,a4,1x,f6.4,2(1x,a9))') &
                    tpot(1,i),tpot(2,i),mword(nmptr),mmword,scale14(i),(botyword(nbotyptr(j)),j=1,nboty)
                endif
              else
                if (ncombipower(i).eq.6) then
                ...
                elseif (ncombipower(i).eq.2) then
                  write(iout,'(''lenn epsilon geometric '',i2,1x,i2,1x,a5,1x,a4,1x,f6.4,2(1x,a9))') &
                    im,in,mword(nmptr),mmword,scale14(i),(botyword(nbotyptr(j)),j=1,nboty)
                elseif (ncombipower(i).eq.1) then
                  write(iout,'(''lenn epsilon product '',i2,1x,i2,1x,a5,1x,a4,1x,f6.4,2(1x,a9))') &
                    im,in,mword(nmptr),mmword,scale14(i),(botyword(nbotyptr(j)),j=1,nboty)
                endif
              endif
            else
              if (lnoninteger) then
                ...
                elseif (ncombipower(i).eq.2) then
                  write(iout,'(''lenn epsilon geometric '',f7.4,1x,f7.4,1x,a5,1x,a4,2(1x,a9))')  &
                    tpot(1,i),tpot(2,i),mword(nmptr),mmword,(botyword(nbotyptr(j)),j=1,nboty)
                elseif (ncombipower(i).eq.1) then
                  write(iout,'(''lenn epsilon product '',f7.4,1x,f7.4,1x,a5,1x,a4,2(1x,a9))')  &
                    tpot(1,i),tpot(2,i),mword(nmptr),mmword,(botyword(nbotyptr(j)),j=1,nboty)
                endif
              else
                if (ncombipower(i).eq.6) then
                ...
                elseif (ncombipower(i).eq.2) then
                  write(iout,'(''lenn epsilon geometric '',i2,1x,i2,1x,a5,1x,a4,2(1x,a9))')  &
                    im,in,mword(nmptr),mmword,(botyword(nbotyptr(j)),j=1,nboty)
                elseif (ncombipower(i).eq.1) then
                  write(iout,'(''lenn epsilon product '',i2,1x,i2,1x,a5,1x,a4,2(1x,a9))')  &
                    im,in,mword(nmptr),mmword,(botyword(nbotyptr(j)),j=1,nboty)
                endif
              endif
            endif
              ...
              if (lnoninteger) then
                ...
                elseif (ncombipower(i).eq.2) then
                  write(iout,'(''lenn epsilon geometric '',f7.4,1x,f7.4,1x,a4,1x,f6.4,2(1x,a9))')  &
                    tpot(1,i),tpot(2,i),mmword,scale14(i),(botyword(nbotyptr(j)),j=1,nboty)
                elseif (ncombipower(i).eq.1) then
                  write(iout,'(''lenn epsilon product '',f7.4,1x,f7.4,1x,a4,1x,f6.4,2(1x,a9))')  &
                    tpot(1,i),tpot(2,i),mmword,scale14(i),(botyword(nbotyptr(j)),j=1,nboty)
                endif
              else
                if (ncombipower(i).eq.6) then
                ...
                elseif (ncombipower(i).eq.2) then
                  write(iout,'(''lenn epsilon geometric '',i2,1x,i2,1x,a4,1x,f6.4,2(1x,a9))')  &
                    im,in,mmword,scale14(i),(botyword(nbotyptr(j)),j=1,nboty)
                elseif (ncombipower(i).eq.1) then
                  write(iout,'(''lenn epsilon product '',i2,1x,i2,1x,a4,1x,f6.4,2(1x,a9))')  &
                    im,in,mmword,scale14(i),(botyword(nbotyptr(j)),j=1,nboty)
                endif
              endif
            else
              if (lnoninteger) then
                ...
                elseif (ncombipower(i).eq.2) then
                  write(iout,'(''lenn epsilon geometric '',f7.4,1x,f7.4,1x,a4,2(1x,a9))')  &
                    tpot(1,i),tpot(2,i),mmword,(botyword(nbotyptr(j)),j=1,nboty)
                elseif (ncombipower(i).eq.1) then
                  write(iout,'(''lenn epsilon product '',f7.4,1x,f7.4,1x,a4,2(1x,a9))')  &
                    tpot(1,i),tpot(2,i),mmword,(botyword(nbotyptr(j)),j=1,nboty)
                endif
              else
                if (ncombipower(i).eq.6) then
                ...
                elseif (ncombipower(i).eq.2) then
                  write(iout,'(''lenn epsilon geometric '',i2,1x,i2,1x,a4,2(1x,a9))')  &
                    im,in,mmword,(botyword(nbotyptr(j)),j=1,nboty)
                elseif (ncombipower(i).eq.1) then
                  write(iout,'(''lenn epsilon product '',i2,1x,i2,1x,a4,2(1x,a9))')  &
                    im,in,mmword,(botyword(nbotyptr(j)),j=1,nboty)
                endif
              endif
            endif
...
!
      ...
      elseif (neamfn.eq.12) then
        if (neamfnmeamorder(i).gt.1) then
          write(iout,'(''meam_functional igarashi '',i2,2(1x,a3))') neamfnmeamorder(i)-1,(meamword(j),j=1,nmeamword)
        else
      ...
      elseif (neamfn.eq.13) then
        if (neamfnmeamorder(i).gt.1) then
          write(iout,'(''meam_functional spline '',i2,2(1x,a3))') neamfnmeamorder(i)-1,(meamword(j),j=1,nmeamword)
        else
...
!***********************
  ...
  do nkim = 1,nkimmodelloc
    write(iout,'(''kim_model'')')
    write(iout,'(a80)') kim_model(nkim)
  enddo
!
!  Free local memory
!
