...
!
    if (lkim_model) then
      write(ioout,'(/,''  OpenKIM models :'',/)')
      write(ioout,'(''--------------------------------------------------------------------------------'')')
      write(ioout,'('' No.  : Model name / configurations successfully coupled with'')')
      write(ioout,'(''--------------------------------------------------------------------------------'')')
      allocate(cfg_string(ncfg))
      do nkim = 1,nkimmodel
        write(ioout,'(2x,i3,1x,'': '',a72)') nkim,kim_model(nkim)(1:72)
        ii = 0
        do icfg = 1,ncfg
          if (lkim_model_cfg_OK(nkim,icfg)) then
            ii = ii + 1
        ...
        do i = 1,nEDIPspec
          ...
          do j = 1,i
            ...
            if (lEDIPpairOK(ind)) then
              ...
              if (lEDIPpi(ind)) then
                write(ioout,'(2(a5,a1,1x),''sigma'',1x,f10.5,4(1x,f10.5))') &
                ...
                write(ioout,'(2(a5,a1,1x),''pi'',4x,f10.5,2(1x,f10.5))') &
...
!
        ...
        do i = 1,nEDIPspec
          ...
          do j = 1,nEDIPspec
            ...
            do k = 1,j
              ind = ind + 1
              if (lEDIPtriadOK(ind,i).and..not.lEDIP3orig(ind,i)) then
                if (lfirst) then
...
!
        ...
        lout = .true.
!
!  Bond-angle linear cross term 3-body form
!
        do i = 1,nthb
          if (nthrty(i).eq.23.and.iptyp(i).eq.k) then
            if (lout) then
              write(ioout,'(/,''  Bond-Angle Linear cross form:'',/)')
              write(ioout,'(''--------------------------------------------------------------------------------'')')
              write(ioout,'(''       Atom Types        Powers    Force Cst     R0       n        Cutoffs  '')')
              write(ioout,'(''   1       2       3               (eV/rad)    (Angs)           1-2   1-3   2-3  '')')
              write(ioout,'(''--------------------------------------------------------------------------------'')')
              lout = .false.
            endif
            nat1 = ntspec1(i)
            ...
            if (nat3.gt.maxele) cstyp3 = 's'
            if (mmtexc(i).eq.1) then
              write(ioout,'(a5,1x,a1,1x,a5,1x,a1,1x,a5,1x,a1,2(1x,i3),2x,f10.4,1x,2(f5.3,1x),1x,i3,7x,''Bonded'')') &
                lab1,cstyp1,lab2,cstyp2,lab3,cstyp3,(nint(threepoly(l,i)),l=1,2),thbk(i),thrho1(i),thrho2(i), &
                nint(theta(i))*nint(threepoly(3,i))
            else
              write(ioout,'(a5,1x,a1,1x,a5,1x,a1,1x,a5,1x,a1,2(1x,i3),2x,f10.4,1x,2(f5.3,1x),1x,i3,2x,3(1x,f5.2))') &
                lab1,cstyp1,lab2,cstyp2,lab3,cstyp3,(nint(threepoly(l,i)),l=1,2),thbk(i),thrho1(i),thrho2(i), &
                nint(theta(i))*nint(threepoly(3,i)),thr1min(i),thr2min(i),thr3min(i)
              write(ioout,'(59x,3(1x,f5.2))') thr1(i),thr2(i),thr3(i)
            endif
          endif
        enddo
        ...
        do i = 1,nfor
          if (nforty(i).eq.1.and.iptyp(i).eq.k) then
            ...
            elseif (mmfexc(i).eq.2) then
              nbotyptr = n4botype(1,i) + 1
              write(ioout,'(4(a5,1x,a1,1x),1x,g10.4,1x,a1,2x,i2,3x,f6.2,2x,''Improp'',1x,a9,1x,a3)') &
                lab1,cstyp1,lab2,cstyp2,lab3,cstyp3,lab4,cstyp4,fork(i),sgs(ind),abs(npfor(i)), &
                phi0,botyword(nbotyptr),botyword2(n4botype(2,i))
            else
...
!
        ...
        do i = 1,nfor
          if (nforty(i).eq.2.and.iptyp(i).eq.k) then
            ...
            elseif (mmfexc(i).eq.2) then
              nbotyptr = n4botype(1,i) + 1
              write(ioout,'(4(a5,1x,a1,1x),1x,g11.5,3x,i2,6x,''Improp'',1x,a9,1x,a3)') &
                lab1,cstyp1,lab2,cstyp2,lab3,cstyp3,lab4,cstyp4,fork(i),npfor(i),botyword(nbotyptr),botyword2(n4botype(2,i))
            else
...
!
        ...
        do i = 1,nfor
          if (nforty(i).eq.4.and.iptyp(i).eq.k) then
            ...
            elseif (mmfexc(i).eq.2) then
              nbotyptr = n4botype(1,i) + 1
              write(ioout,'(4(a5,1x,a1,1x),1x,g10.5,1x,a1,2x,i2,1x,f8.4,2x,''Improp'',1x,a9,1x,a3)') &
                lab1,cstyp1,lab2,cstyp2,lab3,cstyp3,lab4,cstyp4,fork(i),sgs(ind),abs(npfor(i)),phi0, &
                botyword(nbotyptr),botyword2(n4botype(2,i))
            else
...
!
        ...
        do i = 1,nfor
          if (nforty(i).eq.5.and.iptyp(i).eq.k) then
            ...
            elseif (mmfexc(i).eq.2) then
              nbotyptr = n4botype(1,i) + 1
              write(ioout,'(4(a5,1x,a1,1x),1x,g14.5,1x,f8.4,5x,''Improp'',1x,a9,1x,a3)') &
                lab1,cstyp1,lab2,cstyp2,lab3,cstyp3,lab4,cstyp4,fork(i),phi0,botyword(nbotyptr),botyword2(n4botype(2,i))
            else
...
!
        ...
        do i = 1,nfor
          if (nforty(i).eq.6.and.iptyp(i).eq.k) then
            ...
            elseif (mmfexc(i).eq.2) then
              nbotyptr = n4botype(1,i) + 1
              write(ioout,'(4(a5,1x,a1,1x),1x,g10.5,1x,a1,2x,i2,3x,f6.2,2x,''Improp'',1x,a9,1x,a3)') &
                lab1,cstyp1,lab2,cstyp2,lab3,cstyp3,lab4,cstyp4,fork(i),sgs(ind),abs(npfor(i)),phi0, &
                botyword(nbotyptr),botyword2(n4botype(2,i))
            else
...
!
        ...
        do i = 1,nfor
          if (nforty(i).eq.13.and.iptyp(i).eq.k) then
            ...
            elseif (mmfexc(i).eq.2) then
              nbotyptr = n4botype(1,i) + 1
              write(ioout,'(4(a5,1x,a1,1x),1x,g10.5,1x,3x,i2,3x,f6.2,2x,''Improp'',1x,a9,1x,a3)') &
                lab1,cstyp1,lab2,cstyp2,lab3,cstyp3,lab4,cstyp4,fork(i),abs(npfor(i)),phi0, &
                botyword(nbotyptr),botyword2(n4botype(2,i))
            else
