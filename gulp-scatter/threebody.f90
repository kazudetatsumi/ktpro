...
!***************************************
  if (.not.l180) then
    if (n3ty.ne.3.and.n3ty.ne.4.and.n3ty.ne.6.and.n3ty.ne.7.and.n3ty.ne.10.and.n3ty.ne.12.and.n3ty.ne.13 &
        .and.n3ty.ne.19.and.n3ty.ne.20.and.n3ty.ne.21.and.n3ty.ne.23) then
!
...
!
        ...
        if (ipivot.eq.1) then
          ...
          e2d(1) = e2d(1) + rkthb*(2.0_dp*delthm1*cos1d1*prd1m1 + ptdelth*prd1m2)*prd2
          e2d(2) = e2d(2) + rkthb*(delthm1*(cos1d1*prd2m1*prd1 + cos1d2*prd1m1*prd2) + ptdelth*prd1m1*prd2m1)
          e2d(3) = e2d(3) + rkthb*(delthm1*cos1d3*prd1m1*prd2)
          e2d(4) = e2d(4) + rkthb*(2.0_dp*delthm1*cos1d2*prd2m1 + ptdelth*prd2m2)*prd1
          e2d(5) = e2d(5) + rkthb*(delthm1*cos1d3*prd2m1*prd1)
        elseif (ipivot.eq.2) then
          if (pr1.ge.2) then
            prd1m2 = rr122*(dble(pr1*(pr1-1))*rd1**(pr1-2) - prd1m1)
          elseif (pr1.eq.1) then
          ...
          e2d(1) = e2d(1) + rkthb*(2.0_dp*delthm1*cos1d1*prd1m1 + ptdelth*prd1m2)*prd2
          e2d(2) = e2d(2) + rkthb*(delthm1*cos1d2*prd1m1*prd2)
          e2d(3) = e2d(3) + rkthb*(delthm1*(cos1d1*prd2m1*prd1 + cos1d3*prd1m1*prd2) + ptdelth*prd1m1*prd2m1)
          e2d(5) = e2d(5) + rkthb*(delthm1*cos1d2*prd2m1*prd1)
          e2d(6) = e2d(6) + rkthb*(2.0_dp*delthm1*cos1d3*prd2m1 + ptdelth*prd2m2)*prd1
        else
          if (pr1.ge.2) then
            prd1m2 = rr132*(dble(pr1*(pr1-1))*rd1**(pr1-2) - prd1m1)
          elseif (pr1.eq.1) then
          ...
          e2d(2) = e2d(2) + rkthb*(delthm1*cos1d1*prd1m1*prd2)
          e2d(3) = e2d(3) + rkthb*(delthm1*cos1d1*prd2m1*prd1)
          e2d(4) = e2d(4) + rkthb*(2.0_dp*delthm1*cos1d2*prd1m1 + ptdelth*prd1m2)*prd2
          e2d(5) = e2d(5) + rkthb*(delthm1*(cos1d2*prd2m1*prd1 + cos1d3*prd1m1*prd2) + ptdelth*prd1m1*prd2m1)
          e2d(6) = e2d(6) + rkthb*(2.0_dp*delthm1*cos1d3*prd2m1 + ptdelth*prd2m2)*prd1
        endif
        if (lgrad3) then
!
...
!
! DEBUG
          call outerror('third derivatives not finished for balcross potential',0_i4)
          call stopnow('threebody')
! DEBUG
        endif
      endif
