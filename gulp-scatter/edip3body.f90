...
!  Compute g(r,Z)  *
!*******************
    call EDIP_expfn(rij,cutoffij,EDIP2aprime(indij),EDIP3gamma0(indjk,nspeci),gij,dgijdrij,dgijdZi,lgrad1)
    call EDIP_expfn(rik,cutoffik,EDIP2aprime(indik),EDIP3gamma0(indjk,nspeci),gik,dgikdrik,dgikdZi,lgrad1)
...
!
      ...
      if (lgrad1) then
        ...
        dhargdZi = muZ*harg + dharg*dtauZdZ
