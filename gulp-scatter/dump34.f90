...
!   7/13 Improper sub-option added for torsions
...
!
      ...
      if (n3botype(2,1,i).gt.1) then
        nboty = nboty + 1
        nbotyptr(nboty) = 10 + n3botype(2,1,i)
        wboty(nboty) = botyword(nbotyptr(nboty))
      ...
      if (n3botype(2,2,i).gt.1) then
        nboty = nboty + 1
        nbotyptr(nboty) = 10 + n3botype(2,2,i)
        wboty(nboty) = botyword(nbotyptr(nboty))
      endif
...
!
      ...
      elseif (nthrty(i).eq.23) then
        if (mmtexc(i).eq.1) then
          write(iout,'(''balcross bond '',a5,5(1x,a9))') mword(nmtptr),(wboty(j),j=1,nboty)
          write(iout,'(3(a5,1x,a4,1x),g14.6,2(1x,f8.5),'' &'')') &
            lab1,ctmp(1),lab2,ctmp(2),lab3,ctmp(3),thbk(i),thrho1(i),thrho2(i)
          if (lfit) then
            write(iout,'(1x,f8.4,1x,3i3,1x,3i2)') the,nint(threepoly(3,i)),(nint(threepoly(k,i)),k=1,2),(itmp(5*(i-1)+j),j=1,3)
          else
            write(iout,'(1x,f8.4,1x,3i3)') the,nint(threepoly(3,i)),(nint(threepoly(k,i)),k=1,2)
          endif
        else
          write(iout,'(''balcross '',a5,5(1x,a9))') mword(nmtptr),(wboty(j),j=1,nboty)
          write(iout,'(3(a5,1x,a4,1x),g14.6,2(1x,f8.5),'' &'')') &
            lab1,ctmp(1),lab2,ctmp(2),lab3,ctmp(3),thbk(i),thrho1(i),thrho2(i)
          if (lfit) then
            write(iout,'(x,f8.4,1x,3i3,6(1x,f6.3),3i2)') &
              the,nint(threepoly(3,i)),(nint(threepoly(k,i)),k=1,2),thr1min(i),thr1(i),thr2min(i),thr2(i),thr3min(i),thr3(i), &
              (itmp(5*(i-1)+j),j=1,3)
          else
            write(iout,'(x,f8.4,1x,3i3,6(1x,f6.3))') &
              the,nint(threepoly(3,i)),(nint(threepoly(k,i)),k=1,2),thr1min(i),thr1(i),thr2min(i),thr2(i),thr3min(i),thr3(i)
...
!
      ...
      if (n4botype(2,i).gt.1) then
        nboty = nboty + 1
        nbotyptr(nboty) = 10 + n4botype(2,i)
      endif
...
!
      if (nforty(i).eq.1) then
        ...
        elseif (mmfexc(i).eq.2) then
          if (lfit) then
            write(iout,'(''torsion improper '',a5,3(1x,a9))') mword(nmfptr),(botyword(nbotyptr(j)),j=1,nboty)
            write(iout,'(4(a5,1x,a3,1x),g12.5,1x,i3,1x,g10.5,i2)') &
              lab1,ctmp(1),lab2,ctmp(2),lab3,ctmp(3),lab4,ctmp(4),fork(i),npfor(i),phi0,itmp(6*(i-1)+1)
          else
            write(iout,'(''torsion improper '',a5,3(1x,a9))') mword(nmfptr),(botyword(nbotyptr(j)),j=1,nboty)
      ...
      elseif (nforty(i).eq.2) then
        ...
        elseif (mmfexc(i).eq.2) then
          if (lfit) then
            write(iout,'(''torsion ryckaert '',i1,'' improper '',a5,3(1x,a9))') npfor(i),mword(nmfptr), &
              (botyword(nbotyptr(j)),j=1,nboty)
            write(iout,'(4(a5,1x,a3,1x),g12.5,1x,6i2)') &
              lab1,ctmp(1),lab2,ctmp(2),lab3,ctmp(3),lab4,ctmp(4),fork(i),(itmp(6*(i-1)+j),j=1,npfor(i)+1)
            write(iout,'(5(f12.6,1x))')(forpoly(j,i),j=1,npfor(i))
      ...
      elseif (nforty(i).eq.4) then
        ...
        elseif (mmfexc(i).eq.2) then
          if (lfit) then
            write(iout,'(''torsion esff improper '',a5,3(1x,a9))') mword(nmfptr),(botyword(nbotyptr(j)),j=1,nboty)
            write(iout,'(4(a5,1x,a3,1x),2(g12.5,1x),i3,1x,2i2)') &
              lab1,ctmp(1),lab2,ctmp(2),lab3,ctmp(3),lab4,ctmp(4),fork(i),phi0,npfor(i),(itmp(6*(i-1)+j),j=1,2)
          else
            write(iout,'(''torsion esff improper '',a5,3(1x,a9))') mword(nmfptr),(botyword(nbotyptr(j)),j=1,nboty)
      ...
      elseif (nforty(i).eq.5) then
        ...
        elseif (mmfexc(i).eq.2) then
          if (lfit) then
            write(iout,'(''torharm improper '',a5,3(1x,a9))') mword(nmfptr),(botyword(nbotyptr(j)),j=1,nboty)
            write(iout,'(4(a5,1x,a3,1x),2(g12.5,1x),1x,2i2)') &
              lab1,ctmp(1),lab2,ctmp(2),lab3,ctmp(3),lab4,ctmp(4),fork(i),phi0,(itmp(6*(i-1)+j),j=1,2)
          else
            write(iout,'(''torharm improper '',a5,3(1x,a9))') mword(nmfptr),(botyword(nbotyptr(j)),j=1,nboty)
      ...
      elseif (nforty(i).eq.6) then
        ...
        elseif (mmfexc(i).eq.2) then
          if (lfit) then
            write(iout,'(''torexp improper '',a5,3(1x,a9))') mword(nmfptr),(botyword(nbotyptr(j)),j=1,nboty)
            write(iout,'(4(a5,1x,a3,1x),g12.5,1x,i3,1x,g10.5,'' &'')') &
              lab1,ctmp(1),lab2,ctmp(2),lab3,ctmp(3),lab4,ctmp(4),fork(i),npfor(i),phi0
            write(iout,'(2x,3(g10.6,1x),1x,4i2)') forpoly(2,i),forpoly(3,i),forpoly(4,i),itmp(6*(i-1)+1),(itmp(6*(i-1)+j),j=3,5)
          else
      ...
      elseif (nforty(i).eq.7) then
        ...
        elseif (mmfexc(i).eq.2) then
          if (lfit) then
            write(iout,'(''torexp improper esff '',a5,3(1x,a9))') mword(nmfptr),(botyword(nbotyptr(j)),j=1,nboty)
            write(iout,'(4(a5,1x,a3,1x),g12.5,1x,g12.5,i3,1x,'' &'')') &
              lab1,ctmp(1),lab2,ctmp(2),lab3,ctmp(3),lab4,ctmp(4),fork(i),forpoly(1,i),npfor(i)
            write(iout,'(2x,3(g10.6,1x),1x,5i2)') forpoly(2,i),forpoly(3,i),forpoly(4,i),(itmp(6*(i-1)+j),j=1,5)
          else
      ...
      elseif (nforty(i).eq.8) then
        ...
        elseif (mmfexc(i).eq.2) then
          if (lfit) then
            write(iout,'(''tortaper improper '',a5,3(1x,a9))') mword(nmfptr),(botyword(nbotyptr(j)),j=1,nboty)
            write(iout,'(4(a5,1x,a3,1x),g12.5,1x,i3,1x,g10.5,'' &'')') &
              lab1,ctmp(1),lab2,ctmp(2),lab3,ctmp(3),lab4,ctmp(4),fork(i),npfor(i),phi0
            write(iout,'(2x,g10.6,1x,4i2)') forpoly(2,i),itmp(6*(i-1)+1),(itmp(6*(i-1)+j),j=3,5)
          else
      ...
      elseif (nforty(i).eq.9) then
        ...
        elseif (mmfexc(i).eq.2) then
          if (lfit) then
            write(iout,'(''tortaper improper esff '',a5,3(1x,a9))') mword(nmfptr),(botyword(nbotyptr(j)),j=1,nboty)
            write(iout,'(4(a5,1x,a3,1x),g12.5,1x,g12.5,i3,1x,'' &'')') &
              lab1,ctmp(1),lab2,ctmp(2),lab3,ctmp(3),lab4,ctmp(4),fork(i),forpoly(1,i),npfor(i)
            write(iout,'(2x,g10.6,1x,1x,5i2)') forpoly(2,i),(itmp(6*(i-1)+j),j=1,5)
          else
      ...
      elseif (nforty(i).eq.10) then
        ...
        elseif (mmfexc(i).eq.2) then
          if (lfit) then
            write(iout,'(''torangle improper '',a5,3(1x,a9))') mword(nmfptr),(botyword(nbotyptr(j)),j=1,nboty)
            write(iout,'(4(a5,1x,a3,1x),3(g10.5,1x),1x,3i2)') &
              lab1,ctmp(1),lab2,ctmp(2),lab3,ctmp(3),lab4,ctmp(4),fork(i),forpoly(1,i),forpoly(2,i), &
              (itmp(6*(i-1)+j),j=1,3)
          else
      ...
      elseif (nforty(i).eq.13) then
        ...
        elseif (mmfexc(i).eq.2) then
          if (lfit) then
            write(iout,'(''uff4 improper '',a5,3(1x,a9))') mword(nmfptr),(botyword(nbotyptr(j)),j=1,nboty)
            write(iout,'(4(a5,1x,a3,1x),g10.5,1x,i3,1x,g10.5,i2)') &
              lab1,ctmp(1),lab2,ctmp(2),lab3,ctmp(3),lab4,ctmp(4),fork(i),npfor(i),phi0,itmp(6*(i-1)+1)
          else
            write(iout,'(''uff4 improper '',a5,3(1x,a9))') mword(nmfptr),(botyword(nbotyptr(j)),j=1,nboty)
      ...
      elseif (nforty(i).eq.17) then
        ...
        elseif (mmfexc(i).eq.2) then
          if (lfit) then
            write(iout,'(''torcosangle improper '',a5,3(1x,a9))') mword(nmfptr),(botyword(nbotyptr(j)),j=1,nboty)
            write(iout,'(4(a5,1x,a3,1x),3(g10.5,1x),1x,3i2)') &
              lab1,ctmp(1),lab2,ctmp(2),lab3,ctmp(3),lab4,ctmp(4),fork(i),forpoly(1,i),forpoly(2,i), &
              (itmp(6*(i-1)+j),j=1,3)
          else
...
!
      ...
      if (n6botype(2,i).gt.1) then
        nboty = nboty + 1
        nbotyptr(nboty) = 10 + n6botype(2,i)
      endif
!
