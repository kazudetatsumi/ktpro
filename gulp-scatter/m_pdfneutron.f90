...
!
  ...
  call matrix_inversion(kvT2piinv,3_i4,3_i4,wrk,ifail)
  if (ifail.gt.0) then
  ...
  call matrix_inversion(kvTinv,3_i4,3_i4,wrk,ifail)
  if (ifail.gt.0) then
...
!
  ...
  do icores = 1,ncfoc
    ...
    arraymasses_amu(icores) = rmassers29(icores)*(1.0_dp) !g mol = amu
  ...
  siglengthbysqrtmass = sqrt(siginc_cores_A2/(4.0_dp*pi*arraymasses_kg)) !ers29 2/09
