  subroutine twobody(eatom,ereal,ec6,lgrad1,lgrad2,lgrad3,nor,nor0,npots,npotl, &
                     cut2r,cut2e,cut2s,nmolonly,factor,sfct,spfct,radsum,rtrm1, &
                     sctrm1,sctrm2,qi,qj,lcspair,lperiodic,lregion1,lskipsr, &
                     lskipq,lorder12)
!
...
!*******************************************************************
  subroutine twobody1(eatom,ereal,ec6,lgrad1,lgrad2,lgrad3,nor,nor0,dist1,x1,y1,z1,d0i1,d0j1,deriv1, &
                      ...
                      cut2s,lptrmol1,nmolonly,factor,sfct,spfct,radsum,rtrm1,rtrm21,rtrm31,rtrm321,sctrm1, &
...
!
  call twobody(eatom,ereal,ec6,lgrad1,lgrad2,lgrad3,nor,nor0,npots,npotl,cut2r,cut2e,cut2s,nmolonly, &
               factor,sfct,spfct,radsum,rtrm1,sctrm1,sctrm2,qi,qj,lcspair,lperiodic,lregion1,lskipsr, &
               lskipq,lorder12)
!
