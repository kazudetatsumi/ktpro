  subroutine reciptrmd3g(i,j,c6tot,ktrm6,ktrm62,d3)
!
!  Calculates the reciprocal space contribution to the third
!  derivatives. Gamma point only version to be called from Raman.
!
...
!  symmetry.
!
!   9/13 Created from reciptrmd3
!  12/13 Unused arguments removed
