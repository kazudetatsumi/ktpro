...
!
!  Check on whether relax fit was successful
!
    if (lrelax.and..not.loptallsuccess) then
      nwarn = nwarn + 1
      call outwarning('Not all configurations optimised successfully in relaxed fit',0_i4)
    endif
!
