  subroutine sympotd(nloc,nlocptr,potl,maxd2,minuschi)
!
...
!  adapted version.
!
!  Distributed memory version for parallel use
!
!   2/14 Created from sympot
!
!  On entry:
!
