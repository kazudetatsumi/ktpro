...
!
        derive0self = 0.0_dp
        if (lself) call selfterm(ereal,erecip,ec6,derive0self,factor,fct,ofct,ospfct,1.0_dp,npotl,npots,c6tot, &
...
!
        call twobody(eatom,ereal,ec6,.true.,.true.,.false.,nor,1_i4,npots,npotl,cut2r,cut2q,cut2s, &
                     nmolonly,factor,ofct,ospfct,radsum,rtrm1,sctrm1,sctrm2,qli,qlj,lcspair,lewaldtype, &
