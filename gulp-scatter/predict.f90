...
!  Julian Gale, Curtin University, August 2013
!
!   8/97 call to gasort added (smw)
!   3/98 allow origin change + no energy min (smw)
!   7/00 converted s.t. multi configs allowed (smw)
!   5/09 Calls to x0tostr routines moved from energy to calling routine
!   8/13 Modified so that I/O calls are only from one processor
!
