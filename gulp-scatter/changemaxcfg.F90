...
!  OpenKIM arrays
!
  call realloc(kim_ntype,maxcfg,ierror)
  if (ierror.ne.0) call outofmemory('changemaxcfg','kim_ntype')
  call realloc(kim_types,maxat,maxcfg,ierror)
  if (ierror.ne.0) call outofmemory('changemaxcfg','kim_types')
#ifdef KIM
  call realloc_kim(pkim_model,maxkimmodel,maxcfg,ierror)
  if (ierror.ne.0) call outofmemory('changemaxcfg','pkim_model')
#endif
  ...
  if (ierror.ne.0) call outofmemory('changemaxcfg','kim_nbc')
#ifdef KIM
  call realloc_kim_len(kim_test_descriptor,maxkimmodel,maxcfg,ierror)
  if (ierror.ne.0) call outofmemory('changemaxcfg','kim_test_descriptor')
#endif
!
