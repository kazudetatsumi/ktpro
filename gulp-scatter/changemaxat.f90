...
!
  ...
  use kim_models,     only : kim_types, kim_coord, kim_forces
...
!
  ...
  if (ierror.ne.0) call outofmemory('changemaxat','kim_types')
  call realloc(kim_coord,3_i4,maxat,ierror)
  if (ierror.ne.0) call outofmemory('changemaxat','kim_coord')
  call realloc(kim_forces,3_i4,maxat,ierror)
  if (ierror.ne.0) call outofmemory('changemaxat','kim_forces')
!
!  Frequencies
!
