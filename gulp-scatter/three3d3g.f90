  subroutine three3d3g(i,j,nati,ntypi,natj,ntypj,d3,xc1,yc1,zc1,x21,y21,z21,nthbk)
!
!  Subroutine for third derivatives of three-body energy for i-j
!  pair. Called from raman3. On entry we already have a 
              ...
              do ii1 = 1,3
                do ii2 = 1,3
                  do ii3 = 1,3
                    ...
                    d3(ii3,ii2,ii1) = d3(ii3,ii2,ii1) + trm1
                    d3(ii3,ii2,ii1) = d3(ii3,ii2,ii1) + trm2
                    d3(ii3,ii2,ii1) = d3(ii3,ii2,ii1) + trm3
                    d3(ii3,ii2,ii1) = d3(ii3,ii2,ii1) + trm4
                  enddo
                enddo
              enddo
!
...
!
              d3(1,1,1) = d3(1,1,1) + trm1
              d3(2,1,1) = d3(2,1,1) + trm2
              d3(3,1,1) = d3(3,1,1) + trm3
              d3(1,2,1) = d3(1,2,1) + trm4
              d3(2,2,1) = d3(2,2,1) + trm5
              d3(1,3,1) = d3(1,3,1) + trm6
              d3(3,3,1) = d3(3,3,1) + trm7
              d3(1,1,2) = d3(1,1,2) + trm8
              d3(2,1,2) = d3(2,1,2) + trm9
              d3(1,2,2) = d3(1,2,2) + trm10
              d3(2,2,2) = d3(2,2,2) + trm11
              d3(3,2,2) = d3(3,2,2) + trm12
              d3(2,3,2) = d3(2,3,2) + trm13
              d3(3,3,2) = d3(3,3,2) + trm14
              d3(1,1,3) = d3(1,1,3) + trm15
              d3(3,1,3) = d3(3,1,3) + trm16
              d3(2,2,3) = d3(2,2,3) + trm17
              d3(3,2,3) = d3(3,2,3) + trm18
              d3(1,3,3) = d3(1,3,3) + trm19
              d3(2,3,3) = d3(2,3,3) + trm20
              d3(3,3,3) = d3(3,3,3) + trm21
!
              ...
              do ii1 = 1,3
                do ii2 = 1,3
                  do ii3 = 1,3
                    ...
                    d33(ind,kd3) = d33(ind,kd3) + trm1
                    d33(ind,kd3) = d33(ind,kd3) + trm2
                    d33(ind,kd3) = d33(ind,kd3) + trm3
                    d33(ind,kd3) = d33(ind,kd3) + trm4
                  enddo
                enddo
              enddo
!
...
!
              d33(1,kd3)  = d33(1,kd3) + trm1
              d33(4,kd3)  = d33(4,kd3) + trm2
              d33(5,kd3)  = d33(5,kd3) + trm3
              d33(7,kd3)  = d33(7,kd3) + trm4
              d33(9,kd3)  = d33(9,kd3) + trm5
              d33(10,kd3) = d33(10,kd3) + trm6
              d33(11,kd3) = d33(11,kd3) + trm7
              d33(14,kd3) = d33(14,kd3) + trm8
              d33(17,kd3) = d33(17,kd3) + trm9
              d33(18,kd3) = d33(18,kd3) + trm10
              d33(19,kd3) = d33(19,kd3) + trm11
              d33(21,kd3) = d33(21,kd3) + trm12
              d33(23,kd3) = d33(23,kd3) + trm13
              d33(24,kd3) = d33(24,kd3) + trm14
              d33(27,kd3) = d33(27,kd3) + trm15
!
...
!
              d33(28,kd3) = d33(28,kd3) + trm1
              d33(29,kd3) = d33(29,kd3) + trm2
              d33(30,kd3) = d33(30,kd3) + trm3
              d33(32,kd3) = d33(32,kd3) + trm4
              d33(36,kd3) = d33(36,kd3) + trm5
              d33(37,kd3) = d33(37,kd3) + trm6
              d33(40,kd3) = d33(40,kd3) + trm7
              d33(41,kd3) = d33(41,kd3) + trm8
              d33(42,kd3) = d33(42,kd3) + trm9
              d33(45,kd3) = d33(45,kd3) + trm10
              d33(46,kd3) = d33(46,kd3) + trm11
              d33(50,kd3) = d33(50,kd3) + trm12
              d33(52,kd3) = d33(52,kd3) + trm13
              d33(53,kd3) = d33(53,kd3) + trm14
              d33(54,kd3) = d33(54,kd3) + trm15
!
