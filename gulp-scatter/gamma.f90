...
!
  trm3 = ((2.0_dp*za)**(na2+1))/g_factorial(na2)
  gam = gam*trm3
  dgam = dgam*trm3
  rfct1 = ((dble(na2+1))/za)
  rgam1 = rfct1*gam
...
!
  do i1 = 1,ulim
    ...
    d2zeta22 = d2zeta22 + coff*(d2a22(i1)*b(nni1) + a(i1)*d2b22(nni1) + 2.0_dp*da2(i1)*db2(nni1))
...
!
  ...
  g_factorial = 1.0_dp
  do i = 2,n
    g_factorial = g_factorial*dble(i)
  enddo
!
  return
  end
