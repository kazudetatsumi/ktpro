...
!   8/13 Scatter modifications merged back
!
!  Conditions of use:
!
...
!
  ...
  if (l1000) goto 1000
  if (lwordok) goto 50
  call potwordk(iotmp,word,lwordok,iline,line,l55,l1000,linr,lint,.false.,lfflags,ncurr)
  if (l55) goto 55
  if (l1000) goto 1000
  if (lwordok) goto 50
  ...
  if (l1000) goto 1000
  if (lwordok) goto 50
  call scatterword(iotmp,word,lwordok,iline,line,l55,l1000,ncurr)
  if (l55) goto 55
  if (l1000) goto 1000
  if (lwordok) goto 50
