...
plt.subplot(6,1,1)
plt.plot(cdataA0[:,0],cdataA0[:,1]/4.0,color="red",label="aSi3N4_1")
plt.plot(cdataA0[:,0],cdataA0[:,2]/4.0,':',color="red",label="aSi3N4_2")
plt.plot(sdataA0[:,0],sdataA0[:,1],color="blue",label="bSi3N4_1")
plt.plot(sdataA0[:,0],sdataA0[:,2],':',color="blue",label="bSi3N4_2")
...
plt.subplot(6,1,2)
plt.plot(cdataA1[:,0],cdataA1[:,1]/4.0,color="red",label="aSi3N4_1")
plt.plot(cdataA1[:,0],cdataA1[:,2]/4.0,':',color="red",label="aSi3N4_2")
plt.plot(sdataA1[:,0],sdataA1[:,1],color="blue",label="bSi3N4_1")
plt.plot(sdataA1[:,0],sdataA1[:,2],':',color="blue",label="bSi3N4_2")
plt.ylim(0,200)
#plt.legend(loc='upper right')
plt.xlabel("Omega [THz]")
plt.ylabel("JDOS [1/THz]")
...
plt.subplot(6,1,3)
plt.plot(cdataA2[:,0],cdataA2[:,1]/4.0,color="red",label="aSi3N4_1")
plt.plot(cdataA2[:,0],cdataA2[:,2]/4.0,':',color="red",label="aSi3N4_2")
plt.plot(sdataA2[:,0],sdataA2[:,1],color="blue",label="bSi3N4_1")
plt.plot(sdataA2[:,0],sdataA2[:,2],':',color="blue",label="bSi3N4_2")
plt.ylim(0,200)
#plt.legend(loc='upper right')
plt.xlabel("Omega [THz]")
plt.ylabel("JDOS [1/THz]")
...
plt.subplot(6,1,4)
plt.plot(cdataK0[:,0],cdataK0[:,1]/4.0,color="red",label="aSi3N4_1")
plt.plot(cdataK0[:,0],cdataK0[:,2]/4.0,':',color="red",label="aSi3N4_2")
plt.plot(sdataK0[:,0],sdataK0[:,1],color="blue",label="bSi3N4_1")
plt.plot(sdataK0[:,0],sdataK0[:,2],':',color="blue",label="bSi3N4_2")
plt.ylim(0,200)
#plt.legend(loc='upper right')
plt.xlabel("Omega [THz]")
plt.ylabel("JDOS [1/THz]")
...
plt.subplot(6,1,5)
plt.plot(cdataK1[:,0],cdataK1[:,1]/4.0,color="red",label="aSi3N4_1")
plt.plot(cdataK1[:,0],cdataK1[:,2]/4.0,':',color="red",label="aSi3N4_2")
plt.plot(sdataK1[:,0],sdataK1[:,1],color="blue",label="bSi3N4_1")
plt.plot(sdataK1[:,0],sdataK1[:,2],':',color="blue",label="bSi3N4_2")
plt.ylim(0,200)
#plt.legend(loc='upper right')
plt.xlabel("Omega [THz]")
plt.ylabel("JDOS [1/THz]")
...
plt.subplot(6,1,6)
plt.plot(cdataK2[:,0],cdataK2[:,1]/4.0,color="red",label="aSi3N4_1")
plt.plot(cdataK2[:,0],cdataK2[:,2]/4.0,':',color="red",label="aSi3N4_2")
plt.plot(sdataK2[:,0],sdataK2[:,1],color="blue",label="bSi3N4_1")
plt.plot(sdataK2[:,0],sdataK2[:,2],':',color="blue",label="bSi3N4_2")
plt.ylim(0,200)
#plt.legend(loc='upper right')
plt.xlabel("Omega [THz]")
plt.ylabel("JDOS [1/THz]")
