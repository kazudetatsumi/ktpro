...
def sqrun_kde_hist_2lore():
    ...
    #proj.optimize(variables=[0.45, 0.0198, 0.55, 0.00009, 0.00001, 0.07], figname="qens_kde_fit2.png")
    proj.optimize(variables=[0.20, 0.0215, 0.28, 0.0001, 0.006, 0.07], figname="qens_kde_fit2.png")
